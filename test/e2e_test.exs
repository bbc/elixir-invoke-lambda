defmodule E2eTest do
  ...
  @expected_invoke_headers [
    ...
    {"authorization", "AWS4-HMAC-SHA256 Credential=aws-access-key/20190207/eu-west-1/lambda/aws4_request, SignedHeaders=host;x-amz-date, Signature=hex"}, 
  ...
  test "GET & POST AWS requests are sent correctly" do
    with_mocks([
      ...
      assert_called HTTPoison.post(@expected_invocation_url, @expected_body, @expected_invoke_headers)
